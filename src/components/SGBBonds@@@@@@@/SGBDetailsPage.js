...
import G20924 from "../../assets/images/Sgb/Group 20924.svg";
...
const SGBDetailsPage = (props) => {
  const { handleRange, selectedRange } = props;
  ...
  const getGoldReturnsEightYears = (goldprice) => {
    let totalReturns =
      goldprice * 10 * [1 + (8 * 2.5) / 100] + goldprice * 10 * 1.2;
      ...
      <div className='sgb-dp-container'>
        ...
        <section id='SGB-details'>
          ...
          <div class='sgb-details-container'>
            ...
            <div class='sgb-details-card'>
              ...
              <div class='price-input'>
               <div id='price' class='sgb-details-price-bubble'>
                  ₹
                  {selectedRange !== 0 &&
                    Number(selectedRange).toLocaleString()}
                </div>
            ...
            <div class='sgb-details-card'>
              <p class='sgb-detail-card-heading'>Tradable in Stock Market</p>
              <div class='img'>
                <img src={G20875} alt='' />
              </div>
              <div class='sgb-detail-card-info'>
            ...
            <div class='sgb-details-card'>
              <p class='sgb-detail-card-heading'>Exit Period</p>
              <div class='img'>
                <img src={G20924} alt='' />
              </div>
              <div class='sgb-detail-card-info'>
              ...
              <div class='comparison-container'>
                ...
                <div class='comparsion-1'>
                  ...
                  <div class='total-returns'>
                    <p>Total Returns</p>
                    <p>
                      ₹{Number(sgbData.highprice * 10 * 1.2).toLocaleString()}
                    </p>
                    <p class='after'>After 8 Years</p>
                    <span>
                      <span>
          ...
          <div class='about'>
            <div class='info'>
              <p>
                ...
                <br class='mobile-line-breaks' />
                cash on maturity. SGB is free from
                <br class='desktop-line-breaks' />
        ...
        {/* dynamic ipo cards */}
        <section className={s.section7} style={{marginLeft: '7rem'}}>
