...
const NCDApplyForm = (props) => {
    ...
    return (
        <>
                            ...
                            <div class="card_box h-100 big_card">
                                <div class="ipo_box_main">
                                    <div class="ipo_box_main_left">
                                        ...
                                        <span class="d-block text-center pt-1">NCD</span>
                                    </div>
                                    <div class="ipo_box_main_right">
                                        <div class="title_main">
                                            <h2>IIFL Home Finance Bonds</h2>
                                        </div>
                                    </div>
                                </div>
                                <ul class="innner_grid mt-3 mt-md-3">
                                    <li>Rating<span class="d-block">AA+</span></li>
                                    <li>Min. Investment<span class="d-block"><span class="rupee small">`</span>10,000 </span></li>
                                    <li>Fixed Returns<span class="d-block">10%</span></li>
            ...
            <section class="section pt-0" id="SelectHomeBond">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <p><span>Take the first step by selecting the series you want to invest in</span> ( you can apply in multiple areas )</p>
                            <div class="card_box" id="listBonds">
                                <div class="selected pb-3 mb-4">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                            <div class="checkbox_main">
                                                <input id="series1" type="checkbox" checked />
                                                <label class="font-weight-normal" for="series1">
                                                    <h4 class="m-0">Series 1</h4>
                                                    <span><small class="text-gray">Tenure</small> 39 MON</span> <span><small class="text-gray">Interest Frequency</small> ANNUALLY</span>
                                                </label>
                                                <span></span> </div>
                                        </div>
                                        <div class="col-4 col-sm-6 col-md-6 col-lg-2 text-left  mob-text-left">
                                            <label class="panel-lable">Price / Unit</label>
                                            <h4 class="m-0"><span class="rupee small">`</span> 1,000</h4>
                                        </div>
                                        <div id="dvInputAmt" class="col-8 col-sm-6 col-md-6 col-lg-4 text-center">
                                            <label class="panel-lable">Enter Amount ( Min 10 Units )</label>
                                            <div class="col-xs-10 p-0 inputAmt" style={{margin: "auto"}}>
                                ...
                                <div class="selected pb-3 mb-4">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                            <div class="checkbox_main">
                                                <input id="series2" type="checkbox" checked />
                                                <label class="font-weight-normal" for="series2">
                                                    <h4 class="m-0">Series 2</h4>
                                                    <span><small class="text-gray">Tenure</small> 39 MON</span> <span><small class="text-gray">Interest Frequency</small> ANNUALLY</span>
                                                </label>
                                                <span></span> </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                            <div class="checkbox_main">
                                                ...
                                                <label class="font-weight-normal" for="series3">
                                                    <h4 class="m-0">Series 3</h4>
                                                    <span><small class="text-gray">Tenure</small> 60 MON</span> <span><small class="text-gray">Interest Frequency</small> ANNUALLY</span>
                                                </label>
                                                <span></span> </div>
                                        </div>
                                        <div class="col-4 col-sm-6 col-md-6 col-lg-2 text-left  mob-text-left">
                        ...
                        <div class="col-12">
                            <div class="inside_gray_box p-4">
                                <div class="row align-items-center">
                                    ...
                                    {/* <div class="col-12"> <a href="#">Click here to add holder details in case of joint Demat Account.</a> </div> */}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-md modal-dialog-centered">
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body pt-0">
                                <div id="dvConfirmApp" class=" m-auto text-center ">
                                    <h3 class="mt-0">Confirm Application</h3>
                                    <div class="tableBonds">
                                        <table class="confirm_application_table w-100 my-3">
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                    <td class="font-weight-normal text-left">Series 1</td>
                                                    <td class="font-weight-bold">2 Lots @ <span class="rupee">`</span> 1,000</td>
                                                </tr>
                                                <tr>
                                                    <td class="font-weight-normal text-left">Series 2</td>
                                                    <td class="font-weight-bold">3 Lots @ <span class="rupee">`</span> 1,000</td>
                                                </tr>
                                            </tbody></table>
                                    </div>
                                    <button type="button" class="btn primary_btn text-center my-3" id="btnConfirm">Confirm</button>
                                </div>


                                <div class="customer_msg text-center" id="ApplicationRequested" style={{display: "none"}}>
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body pt-0">
                                ...
                                <div id="dvConfirmApp1" class=" m-auto text-center ">
                                    ...
                                    <button type="button" class="btn primary_btn text-center my-3" id="btnConfirm1">Confirm</button>
                                </div>
                                <div class="customer_msg text-center" id="ApplicationRequested1" style={{display: "none"}}>
                                    <div class="mb-2"> <i class="fa fa-clock-o fa-3x text-green"></i> </div>
                                    <h3 class="mt-2">Application Requested</h3>
                                    <h5 class="text-gray font-weight-normal pb-2 pb-sm-3">Amount to be blocked <span class="rupee">`</span> 1,000</h5>
                                    ...
                                    <div class="text-center mt-4 mb-3">
                                        <button onclick="window.location.href = 'apply_in_other_category.html';" type="button" class="btn primary_btn" formtarget="_blank" data-dismiss="modal">Download Application Form</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal fade" id="CancelBid" role="dialog">
                    <div class="modal-dialog modal-md modal-md modal-dialog-centered">
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body pt-0 ">
                                <div id="dvConfirmApp11" class=" m-auto text-center ">
