...
import { addGsecsFeatureTableData } from "services/gsecServices";

const AddGsecsFeatureTableData = () => {
    ...
    const handleAdd = async () => {
        ...
        try {
            setLoading(true);
            await addGsecsFeatureTableData({ title, description });
        } catch (error) {
            console.log(error)
        } finally {
            setTitle('');
...
export default AddGsecsFeatureTableData;
