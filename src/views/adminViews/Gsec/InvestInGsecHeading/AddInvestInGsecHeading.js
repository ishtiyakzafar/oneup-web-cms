...
import { addInvestInGsecHeading } from "services/gsecServices";

const AddInvestInGsecHeading = () => {
    ...
    const handleAdd = async () => {
        ...
        try {
            setLoading(true);
            await addInvestInGsecHeading({ heading });
        } catch (error) {
...
export default AddInvestInGsecHeading;
